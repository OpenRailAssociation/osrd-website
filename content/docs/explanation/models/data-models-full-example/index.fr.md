...
Dans le [dépôt *OSRD*](https://github.com/osrd-project/osrd) se trouve une [bibliothèque python](https://github.com/osrd-project/osrd/tree/dev/core/examples/generated) conçue pour aider à générer des infrastructures dans un format compris par *OSRD*.

L'infrastructure discutée dans cette section peut être générée grâce au fichier [small_infra.py](https://github.com/osrd-project/osrd/blob/dev/core/examples/generated/scripts/small_infra.py). Pour en savoir plus sur les scripts de génération, vous pouvez consulter le [README](https://github.com/osrd-project/osrd/blob/dev/core/examples/generated/README.md) correspondant.
...
Dans le fichier [small_infra.py](https://github.com/osrd-project/osrd/blob/dev/core/examples/generated/scripts/small_infra.py), nous avons des pentes sur les sections de piste *TA6*, *TA7*, *TD0* et *TD1*.
