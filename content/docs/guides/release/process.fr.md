...
* Un focus particulier est effectué sur le bugfix avec le processus suivant :
  1. Une PR de fix est ouverte puis mergée sur la `dev`
  2. Puis une nouvelle PR est ouverte pour reporter le fix sur la branche `staging`
