...
linkTitle: "5 - Search space and decision tree"
weight: 50
---
...
through an opening, when the train needs to reach a point later than it could have.
...
We keep track of how much delay we can add at any given point to handle
