...
The Ks-system (Ks = Kombinationssignal; engl: combination signal) is a german signalling system introduced in 1994 by Deutsche Bahn (DB). It is meant to replace the old H/V- and Hl-system. 
...
To maintain a safe distance between to trains, the separation must account for the following components:
